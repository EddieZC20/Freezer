...
{
    contador++;
    //cout<<"\t\tSe ha agregado una reproduccion a esta cancion";
}
...
int main() {
    ...
    Cancion Canciones[20] = {
        ...
        Cancion ("Rauw Alejandro", "EL EFECTO", 30, "C:\POPO.wav", 0),
        ...
        Cancion ("New Jeans     ", "COOKIE", 30, "C:\Cookie.wav", 0),
            ...
            if (Users[i].getEstado())
            {
                ...
                nombreUsuario = resp;
                        ...
                        do {
                            ...
                            cout << "6. TOP Canciones Globales" <<endl;
                            cout << "Ingrese una opcion: ";
                            cin >> menuOpcion;
                            ...
                            switch (menuOpcion) {
                                ...
                                case 4:
                                    ...
                                    if (beto == 's' || beto == 'S')
                                    {
                                        ...
                                        if (h>=0)
                                        {
                                            PlaySoundA(Canciones[h].getBits().c_str(), NULL, SND_FILENAME | SND_ASYNC);
                                            Canciones[h].sumar();
                                            cout << "Reproduciendo la cancion. \tPresiona Enter para quitar cancion y avanzar\n\n";
                                            system("pause>NULL");
                                            PlaySoundA(NULL, NULL, 0);
                                        }
                                        else
                                ...
                                case 6:
                                    {
                                        cout<<"Artista\t\t\tCanciones\tReproducciones\n\n";
                                    for (int x=0; x<=19; x++)
                                        {
                                            if (Canciones[x].getcontador()>0)
                                            {
                                                cout<<Canciones[x].getArtista()<<"\t\t"<<Canciones[x].getNombreSong()<<"\t\t"<<Canciones[x].getcontador()<<endl;
                                            }
                                        }
                                    system("pause>NULL");
                                    break;
